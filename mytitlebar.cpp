...
void MyTitleBar::initConnections() {
  ...
  connect(m_pButtonRestore, SIGNAL(clicked()), this,
          SLOT(onButtonRestoreClicked()));
  connect(m_pButtonMax, SIGNAL(clicked()), this, SLOT(onButtonMaxClicked()));
  connect(m_pButtonClose, SIGNAL(clicked()), this,
...
// 设置标题栏长度;
void MyTitleBar::setTitleWidth(int width) { this->setFixedWidth(width); }
...
void MyTitleBar::paintEvent(QPaintEvent *event) {
  ...
  if (!m_isTransparent) {
    ...
    //    painter.fillPath(pathBack, QBrush(QColor(m_colorR, m_colorG,
    //    m_colorB)));
  }
...
// 以下为按钮操作响应的槽;
void MyTitleBar::onButtonMinClicked() { emit signalButtonMinClicked(); }
...
void MyTitleBar::onButtonCloseClicked() { emit signalButtonCloseClicked(); }
